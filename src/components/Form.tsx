  ...
  return (
    ...
    className="space-y-5 bg-white shadow p-10 rounded-lg">
        <div className="grid grid-cols-1 gap-3">
            ...
            <select 
                value={activity.category} className="border border-slate-300 p-2 rounded-xl bg-white" name="" id="category"
        ...
        <input type="submit" 
            className="
                disabled:opacity-10 py-2 bg-gray-800 hover:bg-gray-900 w-full font-bold uppercase text-white cursor-pointer"
